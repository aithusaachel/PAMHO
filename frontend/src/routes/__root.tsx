...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "PAMHO" },
      { name: "description", content: "The Pan-African Mental Health Organization (PAMHO) advances policy, research, advocacy, and community care to strengthen mental health across Africa." },
      { name: "author", content: "Lovable" },
      { property: "og:title", content: "PAMHO" },
      { property: "og:description", content: "The Pan-African Mental Health Organization advances policy, research, and community care across Africa." },
